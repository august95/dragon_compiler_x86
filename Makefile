OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/parser.o ./build/node.o ./build/scope.o ./build/datatype.o ./build/expressionable.o ./build/helper.o ./build/token.o ./build/lex_process.o ./build/symresolver.o ./build/codegen.o ./build/fixup.o  ./build/array.o ./build/helpers/buffer.o ./build/helpers/vector.o 
INCLUDES= -I./
